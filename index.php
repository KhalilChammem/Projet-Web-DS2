				...
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	Enjoy our food either in the restaurant or through delivery
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	Get food delivered to your house for free if the order's cost is more than $25
	                        </p>
	                    </div>
	                </div>
				</div>
				<div class="col-md-4">
					<div class="our_qualities_column">
	                    ...
	                    <div class="caption">
	                        ...
	                        <p>
	                        	We're always available to make reservations for you, call us!
	                        </p>
	                    </div>
	                </div>
				</div>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <h4>
                            <span>Email:</span> 
                            <?php echo "VincentRestaurant@gmail.com"; ?>
                            <br> 
                            <span>Phone:</span> 
                            <?php echo "12 345 678"; ?>
                        </h4>
